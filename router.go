...
func routePromptOpenAI(config *Config, instructions string, prompt string, targetNames []string, targets []Target, apiKey string) (string, error) {
...
func routePromptGemini(config *Config, instructions string, prompt string, targetNames []string, targets []Target, apiKey string) (string, error) {
	type part struct {
		Text string `json:"text"`
	}
	type content struct {
...
func routePromptAnthropic(config *Config, instructions string, prompt string, targetNames []string, targets []Target, apiKey string) (string, error) {
